...
In the next chapter, I will briefly discuss the main challenges we chose for evaluation, and I will introduce our baselines methods for solving them using our micro-service for automatically building concept graphs. After that I will present how we made it applicable to an already working system.